...
class Lead(Base):
    ...
    __table_args__ = (
        ...
        Index("lead_converted_account_id_idx", "converted_account_id"),
        Index("lead_converted_contact_id_idx", "converted_contact_id"),
        Index("lead_converted_opportunity_id_idx", "converted_opportunity_id"),
    )
